...
from up.utils.deploy.seg.psyche_caffe import generate_common_param, generate_config

__all__ = ['PsycheParser', 'PsycheProcessor']


@KS_PARSER_REGISTRY.register('psyche')
class PsycheParser(up_parser.Parser):
...
@KS_PROCESSOR_REGISTRY.register('psyche')
class PsycheProcessor(BaseProcessor):
    def process(self):
