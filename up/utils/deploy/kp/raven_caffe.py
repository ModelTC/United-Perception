...
__all__ = ['RavenParser_caffe', 'RavenProcessor_caffe']


@KS_PARSER_REGISTRY.register('raven_caffe')
class RavenParser_caffe(up_parser.Parser):
...
@KS_PROCESSOR_REGISTRY.register('raven_caffe')
class RavenProcessor_caffe(BaseProcessor):
    def process(self):
