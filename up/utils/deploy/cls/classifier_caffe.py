...
__all__ = ['ClassifierParser_caffe']


@KS_PARSER_REGISTRY.register('classifier_caffe')
class ClassifierParser_caffe(up_parser.Parser):
...
@KS_PROCESSOR_REGISTRY.register('classifier_caffe')
class ClassifierProcessor_caffe(BaseProcessor):
    def process(self):
