...
from up.utils.deploy.det.essos import generate_common_param, generate_config


__all__ = ['EssosParser_onnx', 'EssosProcessor_onnx']


@KS_PARSER_REGISTRY.register('essos_onnx')
class EssosParser_onnx(up_parser.Parser):
...
@KS_PROCESSOR_REGISTRY.register('essos_onnx')
class EssosProcessor_onnx(BaseProcessor):
    def process(self):
