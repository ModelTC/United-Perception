...
@KS_PARSER_REGISTRY.register('sphinx_caffe')
class SphinxParser_caffe(up_parser.Parser):
...
@KS_PROCESSOR_REGISTRY.register('sphinx_caffe')
class SphinxProcessor_caffe(BaseProcessor):
    def process(self):
