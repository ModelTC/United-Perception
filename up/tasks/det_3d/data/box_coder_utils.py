import numpy as np
import torch
from up.utils.general.registry_factory import BOX_CODER_REGISTRY


@BOX_CODER_REGISTRY.register('residual')
...
@BOX_CODER_REGISTRY.register('previous_residual')
...
@BOX_CODER_REGISTRY.register('previous_residual_roi')
...
@BOX_CODER_REGISTRY.register('point_residual')
...
def build_box_coder(cfg_box_coder):
    return BOX_CODER_REGISTRY.build(cfg_box_coder)
