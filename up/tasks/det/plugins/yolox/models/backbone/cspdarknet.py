...
from up.tasks.det.plugins.yolov5.models.components import ConvBnAct, Focus, SPP
from up.tasks.det.plugins.yolov5.models.components import Bottleneck as Bottleneckv5
