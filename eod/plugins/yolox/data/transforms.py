...
from eod.plugins.yolov5.data.transforms import RandomPespective, box_candidates
...
@AUGMENTATION_REGISTRY.register('random_perspective_yolox_mot17')
class YoloXRandomPespectiveMot17(RandomPespective):
    def __init__(self,
                 degrees=0.0,
                 translate=0.1,
                 scale=0.5,
                 ...
                 max_try=1,
                 border=(0, 0)):
        super(YoloXRandomPespectiveMot17, self).__init__(degrees,
                                                    translate,
                                                    scale,
                                                    shear,
                                                    perspective,
...
@AUGMENTATION_REGISTRY.register('yolox_mixup_cv2_mot17')
class YoloxMixUp_cv2Mot17(Augmentation):
    def __init__(self, extra_input, input_size, mixup_scale, dataset=None, flip_prob=1, fill_color=114):
        super(YoloxMixUp_cv2Mot17, self).__init__()
        assert extra_input and dataset is not None
        self.dataset = dataset
        self.input_dim = input_size
        self.mixup_scale = mixup_scale
