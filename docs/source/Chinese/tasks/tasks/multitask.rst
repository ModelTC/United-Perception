...
`具体代码 <https://github.com/ModelTC/United-Perception/tree/main/up/tasks/multitask>`_

配置文件
--------

`配置文件 <https://github.com/ModelTC/United-Perception/tree/main/configs/multitask>`_
其中包括示例配置文件
